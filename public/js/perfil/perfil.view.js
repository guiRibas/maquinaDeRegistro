  ...
  var send = true;
    ...
    if (user != null && token != null){
      var settingsToChangeEmail = {
        "async": true,
        "crossDomain": true,
        "url": "http://www.brainsoftsistemas.com.br/Teste/api/pessoa/editaremail",
        "method": "POST",
        "headers": {
  ...
  if (send){
    ...
    if (user != null && token != null){
      var settingsToChangePassword = {
        "async": true,
        "crossDomain": true,
        "url": "http://www.brainsoftsistemas.com.br/Teste/api/pessoa/alterarsenha",
        "method": "POST",
        "headers": {
          "authorization": "Bearer " + token
        },
  ...
  if(send){
    ...
    if (user != null && token != null){
      var settingsToChangeContact = {
        "async": true,
        "crossDomain": true,
        "url": "http://www.brainsoftsistemas.com.br/Teste/api/pessoa/editarendereco",
        "method": "POST",
        "headers": {
          "authorization": "Bearer " + token
        },
