        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs menu-users">
                <li class="nav-item active">
                    <a class="nav-link" href="#first-tab" data-toggle="tab">Selecione o método de pagamento</a>
                </li>
            </ul>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="form-horizontal" id="formCreditsToBuyByCard"
                                              name="formCreditsToBuyByCard" novalidate>
                                            <div class="form-group row">
                                                <div class="col-sm-8">
                                                    <input type="number" id="creditsToBuyByCard"
                                                           name="creditsToBuyByCard" class="form-control"
                                                           required="true" value="1"><span class="help-block-none">Créditos.</span>
                                                </div>
                                                <div class="col-sm-4">
                                                    <button id="btnUpByCard" class="btn btn-success btn-action-up">+
                                                    </button>
                                                    <button id="btnDownByCard"
                                                            class="btn btn-secondary btn-action-down">-
                                                    </button>
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                value="{{session()->get('user.email')}}" @endif><span
                                                class="help-block-none">E-mail para prosseguir com o pagamento.</span>
                                            </div>
                                            <div class="form-group row">
                                                <input type="number" id="qtdOfPartsByCard" name="qtdOfPartsByCard"
                                                       class="form-control" required="true" value="1" min="1"
                                                       max="6"><span
                                                class="help-block-none">Quantidade de parcelas. (máximo 6)</span>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12" id="divSubmitBuyCreditByCard">
                                                    ...
                                                    <button type="submit" id="submitBuyCreditByCard"
                                                            name="submitBuyCreditByCard" class="btn btn-success">
                    ...
                    <div id="modalTicket" class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="form-horizontal" id="formCreditsToBuyByTicket"
                                              name="formCreditsToBuyByTicket" novalidate>
                                            <div class="form-group row">
                                                <div class="col-sm-8">
                                                    <input type="number" id="creditsToBuyByTicket"
                                                           name="creditsToBuyByTicket" class="form-control"
                                                           required="true" value="1"><span class="help-block-none">Créditos.</span>
                                                </div>
                                                <div class="col-sm-4">
                                                    <button id="btnUpByTicket" class="btn btn-success btn-action-up">+
                                                    </button>
                                                    <button id="btnDownByTicket"
                                                            class="btn btn-secondary btn-action-down">-
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                value="{{session()->get('user.completeName')}}" @endif><span
                                                class="help-block-none">Nome Completo.</span>
                                            </div>
                                            <div class="form-group row">
                                                <input type="text" id="cpf" name="cpf" class="form-control"
                                                       required="true" @if (session()->exists('user.cpf'))
                                                value="{{session()->get('user.cpf')}}" @endif><span
                                                class="help-block-none">CPF (somente números).</span>
                                                <input type="hidden" id="totalByTicket" name="totalByTicket">
                                            </div>
                                            <div class="form-group row">
                                                <input type="text" id="email" name="email" class="form-control"
                                                       required="true" @if (session()->exists('user.email'))
                                                value="{{session()->get('user.email')}}" @endif><span
                                                class="help-block-none">E-mail para cópia do boleto.</span>
                                            </div>
                                            <p id="pTotalOrderByTicket">Total do pedido: <strong>R$</strong><strong
                                                id="strongTotalByTicket"></strong></p>
                                            <p class="totalDiscount"></p>
                                            <div class="form-group row">
                                                <div class="col-md-12" id="divSubmitBuyCreditByTicket">
                                                    <img class="sale" src="images/promo.png" alt="">
                                                    <button type="submit" id="submitBuyCreditByTicket"
                                                            name="submitBuyCreditByTicket" class="btn btn-success">
                                                        <span class="glyphicon glyphicon-file"></span>Finalizar
                                                        Pedido!
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
                                        <p id="infoTicket">*Confira seus dados, pois estes estarão presentes no
                                            Boleto.</p>
                                    </div>
                                </div>
                            </div>
