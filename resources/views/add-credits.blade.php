                                            ...
                                            <form class="form-horizontal" id="formCreditsToBuyByCard"
                                                ...
                                                <div class="form-group row">
                                                    <input type="text" id="emailByCard" name="emailByCard"
                                                           class="form-control" required="true" @if (session()->exists('user.email'))
                                                ...
                                                <div class="form-group row">
                                                    <input type="number" id="qtdOfPartsByCard" name="qtdOfPartsByCard"
                                                           class="form-control" required="true" value="1"><span
                                                            class="help-block-none">Quantidade de parcelas.</span>
                                                </div>
                                            ...
                                            <form class="form-horizontal" id="formCreditsToBuyByTicket"
                                                ...
                                                <div class="form-group row">
                                                    <input type="text" id="completeName" name="completeName"
                                                           class="form-control" required="true" @if (session()->exists('user.completeName'))
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12" id="divSubmitBuyCreditByTicket">
                                                        ...
                                                        <button type="submit" id="submitBuyCreditByTicket"
                                                            ...
                                                            <span class="glyphicon glyphicon-file"></span>Finalizar Pedido!
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
